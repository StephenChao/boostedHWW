...
if [ $resonant = 0 ]; then #doing nonresonant fits
    ...
    do 
        ...
        maskunblindedargs+="mask_${srb}=1,mask_${cr}=1,"
        maskunblindedargs+="mask_${srb}Blinded=0,mask_${cr}Blinded=0,"
        maskblindedargs+="mask_${srb}=0,mask_${cr}=0,"
        maskblindedargs+="mask_${srb}Blinded=1,mask_${cr}Blinded=1,"
    done
