...
def main(args):
    ...
    commands =  [
        f"/home/pku/zhaoyz/Higgs/boostedHWW/combine/scripts/run_unblinded.sh --impactsf {p}" for p in ps
    ]
    ...
    collect_command = f"/home/pku/zhaoyz/Higgs/boostedHWW/combine/scripts/run_unblinded.sh  --impactsc {','.join(ps)}"
