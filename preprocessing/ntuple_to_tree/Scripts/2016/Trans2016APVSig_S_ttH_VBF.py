...
path_tree = "/data/pubfs/zhaoyz/Tree/V5/Splitted/2016APV/Signal/" # Your dir for Ntuple file waiting for TransferTree,waiting for changing.
        ...
        if process in das:
            ...
            for file in os.listdir(file_dir1+das):
                if file.endswith('.root'):
                    ...
                    os.system("python runEDBR2PKUTree.py --inputfile \"%s/%s\" --outputfile \"%s/Tree_%s\" --year \"2016preVFP\" --sampleXS %s --Nevents %ld --channel \"HWW\" --IsData 100 -S "%(file_dir1+das,file,path_tree+das,file,process_dict[process],nEvents_all))
