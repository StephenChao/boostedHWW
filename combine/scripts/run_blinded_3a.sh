...
if [ $resonant = 0 ]; then #doing nonresonant fits
    ...
    do 
        ...
        maskunblindedargs+="mask_${sra}=1,mask_${cr}=1,"
        maskunblindedargs+="mask_${sra}Blinded=0,mask_${cr}Blinded=0,"
        maskblindedargs+="mask_${sra}=0,mask_${cr}=0,"
        maskblindedargs+="mask_${sra}Blinded=1,mask_${cr}Blinded=1,"
    done
