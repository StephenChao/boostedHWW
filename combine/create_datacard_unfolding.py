...
sig_keys_dict = {
    ...
    "ggF_200_300" : "ggH_hww_200_300",
    "ggF_300_450" : "ggH_hww_300_450",
    "ggF_450_Inf" : "ggH_hww_450_Inf",
    "VBF" : "qqH_hww",
    "WH"  : "WH_hww",
    "ZH"  : "ZH_hww",
    "ttH" : "ttH_hww",
...
nuisance_params = {
    ...
    f"PDF_qqH_ACCEPT_{CMS_PARAMS_LABEL}": Syst(
        ...
        value_down = pdf_scale_acc_dict["VBF"]["down"]   
    ),
    ...
    "alpha_s" : Syst(
        prior="lnN", 
        samples=["VBF","WH","ZH","ttH"], 
        value={"VBF":1.005,"WH":1.009,"ZH":1.009,"ttH":1.020},
        diff_samples=True,
        ),
